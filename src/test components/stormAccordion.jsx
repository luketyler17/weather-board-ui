...
export default function StormHomeAccordion() {
  const {stormSplashToggle, capeStormToggle, kscStormToggle, psfbStormToggle} = useContext(AppContext)
  const [expanded, setExpanded] = React.useState( capeStormToggle === false && kscStormToggle === false ? 'panel3' : (capeStormToggle === true) ? 'panel1'  : 'panel2');
