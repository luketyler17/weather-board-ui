...
export default function SevereStormInputText({lightningTime, lightningTime2, setlightningTime2, setlightningTime, setStartTime, setEndTime, startTime, endTime}) {
